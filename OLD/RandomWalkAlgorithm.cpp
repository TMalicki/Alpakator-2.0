...
void RandomWalkAlgorithm::moveInDirection(sf::Vector2u& startingPoint, sf::Vector2i direction)
{
	startingPoint = static_cast<sf::Vector2u>(static_cast<sf::Vector2i>(startingPoint) + direction);
}
